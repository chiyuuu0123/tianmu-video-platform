...
public class VideoServiceImpl extends ServiceImpl<VideoMapper, Video>
    ...
    public TripleActionResponse tripleAction(VideoActionRequest videoActionRequest) {
        ...
        ThrowUtils.throwIf(userStats == null, ErrorCode.USER_NOT_EXISTS);
        ...
        if (!hasCoined) {
            ...
            boolean coinDeducted = userStatsService.lambdaUpdate()
                    .setSql("coin_count = coin_count - 1")
                    .eq(UserStats::getUserId, uid)
                    .gt(UserStats::getCoinCount, 0)
                    .update();
